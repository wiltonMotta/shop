...
return [
    ...
    'order'             => [
        ...
        'order_base_take_verify_number_title'   => '已核销：',
    ...
    'orderaftersale'    => [
        ...
        'aftersale_refuse_cancel_msg_tips'      => '取消当前售后订单后重新申请，确认继续吗？',
        'base_apply_order_no_title'             => '订单编号：',
        'base_apply_warehouse_title'            => '出货服务：',
