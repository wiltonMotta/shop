...
return [
    ...
    'no_orderaftersale'                                     => 'No relevant after-sales orders',
    ...
    'store_bind_form_register_name'                          => 'No account, go to register',
    ...
    'choice_goods_title'                                    => 'Select product',
    'add_goods_title'                                       => 'Add product',
    ...
    'trace_source_title'                                    => 'Trace Source',
    'print_title'                                           => 'Print',
    ...
    'chat_title'                                            => 'Chat',
    'online_customer_title'                                 => 'Online Customer',
    'gift_title'                                            => 'Gift',
    ...
    'public_account_title'                                  => 'official account',
    'life_account_title'                                    => 'Life Account',
    'region_title'                                          => 'Area',
    ...
    'platform_client_title'                                 => 'Platform client',
    'start_time_title'                                      => 'Start time',
    'expire_time_title'                                     => 'expiration time',
    'use_guide_title'                                       => 'Use Guide',
    // 商品基础相关
    'goods_name'                                            => 'Goods Name',
    'goods_add_name'                                        => 'Goods Add',
    'goods_choice_name'                                     => 'Goods Choice',
    'goods_params'                                          => 'Product Specs',
    'goods_spec'                                            => 'Product Specs',
    'goods_base'                                            => 'Product foundation',
    ...
    'form_close_reason'                                     => 'Close reason',
    'form_close_reason_message'                             => 'Close Reason Format 1-230 characters',
    ...
    'common_goods_base_data_fields' => [
        ...
        'produce_region_name'     => 'Place of production',
        'spec_weight'             => 'Spec and weight',
        'spec_volume'             => 'Spec and volume',
        'spec_coding'             => 'Spec Code',
    ...
    'common_goods_base_fields_list' => [
        ...
        'brand_id'                => 'brand',
        'produce_company'         => 'manufacturing enterprise',
        'produce_region'          => 'Place of production',
    ],
    // token生成规则
    ...
    'common_service'            => [
        ...
        'buy'               => [
            ...
            'goods_spec_inventory_dec_fail_tips'    => 'Spec inventory deduction failed',
        ...
        'goodsspectemplate'     => [
            ...
            'form_item_content_placeholder'         => 'Spec value (multiple values can be achieved by entering Enter)',
            'form_item_content_message'             => 'Spec value format: 1~1000 characters',
            // 保存
        ...
        'goods'                 => [
            // 表单
            'form_item_title'                           => 'Product Name',
            'form_item_title_message'                   => 'Product name format 1-600 characters',
            'form_item_category_id'                     => 'Product Category',
            'form_item_category_id_message'             => 'Please select at least one product category',
            'form_item_simple_desc'                     => 'Product Brief',
            'form_item_simple_desc_message'             => 'Please provide a brief description of the product, with a maximum of 230 characters',
            'form_item_spec_desc'                       => 'Spec Description',
            'form_item_spec_desc_message'               => 'Please fill in the specification description, with a maximum of 230 characters',
            'form_item_approval_number'                 => 'Approval Number',
            'form_item_approval_number_message'         => 'Please fill in the approval number, up to 180 characters',
            'form_item_approval_number_expire'          => 'Validity period of approval number',
            'form_item_approval_number_expire_message'  => 'Please select the validity period of the approval number',
            'form_item_batch_number'                    => 'Batch Number',
            'form_item_batch_number_message'            => 'Please fill in the batch number, up to 180 characters',
            'form_item_batch_number_expire'             => 'Batch number validity period',
            'form_item_batch_number_expire_message'     => 'Please select batch number validity period',
            'form_item_coding'                          => 'Product Code',
            'form_item_coding_message'                  => 'Please fill in the product code, up to 180 characters',
            'form_item_model'                           => 'Product Model',
            'form_item_model_message'                   => 'Please fill in the product model with a maximum of 180 characters',
            'form_item_brand_id'                        => 'brand',
            'form_item_brand_id_message'                => 'Please choose a brand',
            'form_item_produce_company'                 => 'manufacturing enterprise',
            'form_item_produce_company_message'         => 'Please fill in the production enterprise, with a maximum of 180 characters',
            'form_item_produce_region'                  => 'Place of production',
            'form_item_produce_region_message'          => 'Please select the production location',
            'form_item_inventory_unit'                  => 'unit of measurement',
            'form_item_inventory_unit_message'          => 'Measurement unit format 1-6 characters',
            'form_item_give_integral'                   => 'Purchase bonus points ratio',
            ...
            'form_spec_thead_weight_message'        => 'Spec and weight 0~100000000',
            'form_spec_thead_volume_title'          => 'Volume (m ³)',
            'form_spec_thead_volume_message'        => 'Spec volume 0~100000000',
            'form_spec_thead_coding_title'          => 'Coding',
            'form_spec_thead_coding_message'        => 'Spec code can be up to 60 characters',
            ...
            'save_spec_column_repeat_tips'          => 'Spec value columns cannot be repeated',
            'save_spec_value_repeat_tips'           => 'The specification value cannot be repeated',
            'save_spec_name_column_repeat_tips'     => 'Spec name columns cannot be repeated',
            ...
            'delete_spec_type_fail_tips'            => 'Spec type deletion failed',
            'delete_spec_value_fail_tips'           => 'Spec value deletion failed',
            ...
            'goods_admin_nav_list'                  => [
                ...
                'spec' => [
                    ...
                    'tips' => [
                        '1. Batch adding specifications allows you to quickly create product SKUs, which greatly saves SKU editing time. Quick operation data does not affect existing SKU data; it only overwrites SKUs when generating new ones.',
                        '2. You can configure specification templates in the backend under Product Management -> Product Specifications, and select product specification modules to quickly generate corresponding specification data, effectively improving efficiency.',
                        '3. After the product is successfully added, add and configure inventory in Warehouse Management -> Warehouse Products.',
                    ],
                ],
                'spec_images' => [
                ...
                'photo' => [
                    'name' => 'Product Album',
                    'tips' => 'You can drag and drop images to sort them. It is recommended that the images be of the same size (800*800px) and the maximum number of images is 30',
                ],
                'video' => [
                    'name' => 'Product Video',
                    'tips' => 'Videos are more immersive than images and text, and only mp4 format is supported',
                ],
                'app' => [
                    'name' => 'Mobile Details',
                    'tips' => 'After setting up mobile details, they will be displayed in mobile mode (e.g., Mini Programs, APPs)',
                ],
                'web' => [
                    'name' => 'Desktop Details',
                    'tips' => 'Please accurately describe the product features and functions, and upload complete and clear images',
                ],
                'fictitious' => [
                    'name' => 'Virtual Information',
                    'tips' => 'Such as virtual information including card passwords and cloud disk addresses, as well as virtual order types, which will be displayed in the order details after the user makes a purchase',
                ],
                'extends' => [
                    'name' => 'Extended Data',
                ],
                'use_guide' => [
                    'name' => 'User Guide',
                    'tips' => 'Please accurately fill in the product usage instructions and precautions',
                ],
                'seo' => [
        ...
        'orderaftersale'        => [
            ...
            'orderaftersale_step_tips_msg'          => [
                ...
                2 => [
                    'title' => 'Waiting for sellers confirmation and review',
                    'desc'  => 'Returned or refunded, awaiting seller review!',
                ],
                3 => [
                ...
                4 => [
                    'title' => 'The seller has refused. If you have any objections, you can apply again',
        ...
        'order'                 => [
            ...
            // 追溯
            'form_item_trace_source_code'                         => 'Trace Code',
            'form_item_trace_source_code_message'                 => 'Trace code format: 1 to 80 characters',
            'form_item_trace_source_batch_number'                 => 'Batch Number',
            'form_item_trace_source_batch_number_message'         => 'Please fill in the batch number',
            'form_item_trace_source_batch_number_expire'          => 'Batch Validity Period',
            'form_item_trace_source_batch_number_expire_message'  => 'Please select the batch validity period',
            // 发货、取货、服务
    ...
    'common_config'             => [
        ...
        'home_search_prohibit_keywords'  => [
            'name' => 'Search for prohibited keywords',
            'desc' => 'One keyword per line',
        ],
        ...
        'common_is_goods_parameters_custom_mode'  => [
            'name' => 'Custom Mode for Product Parameters',
            'desc' => 'Default: Template Mode',
            'tips' => 'Please select the custom mode for product parameters',
        ],
        'common_goods_base_fields_required_data'  => [
            'name' => 'The basic fields of the product are required under the corresponding category',
            'desc' => 'Include sub levels',
        ],
        'common_goods_admin_nav_custom_data'  => [
            'name' => 'Custom Name and Tips for Product Management Navigation',
        ],
        'common_order_detail_goods_use_guide_title'  => [
            'name' => 'Product User Guide Title in Order Details',
            'desc' => 'Default: User Guide',
        ],
        'common_order_detail_goods_use_guide_describe'  => [
            'name' => 'Product User Guide Description in Order Details',
        ],
        'common_order_trace_source_config'  => [
            'name' => 'Require Trace Information for Specified Category Orders',
            'desc' => 'Default: All Orders. After configuration, trace information must be filled in first before processing the order [Delivery, Pickup, Service].',
        ],
        ...
        'common_goods_close_buy_button'  => [
            ...
            'tips' => 'Please choose to close the product order button',
        ],
        'common_goods_detail_base_fields_show'  => [
            'name' => 'Display of basic fields for product details',
            'tips' => 'Please select the basic fields for displaying product details',
        ],
        'common_app_h5_url'  => [
