...
| 分销 | 可配置向上1~3级返佣或返积分、向下指定用户数量返佣或返积分、用户分享赚取佣金或返积分、统计、小程序商品海报、取货点、佣金可配置具体到SKU(比例和固定金额)、上下级返积分、指定商品返现/返佣/阶梯返佣、客户地图分布、客户拜访、分销员推荐宝、自提地址切换（支持多商户使用）|
| 超级会员 | 等级折扣(具体到商品规格)、满减、手动设置会员等级、付费购买+续费+三级返佣，购物送礼 |
| 限时秒杀 | 自由配置商品折扣或立减限时秒杀、自动开始结束、轮播设置、独立首页，支持多商户 |
| 优惠券 | 满减劵、折扣劵、注册送、用户领取、管理员发放 |
| 钱包 | 用户钱包，在线充值（固定金额或比例赠送+自定义赠送），申请提现 |
| 直播 | 平台和多商户商家在线直播，直播间管理推流开播，直播推荐讲解商品，观看直播拉流（支持所有端）、API直播状态自动同步，支持多商户 |
| 积分商城+签到 | 下单积分抵扣，商品兑换，积分加金额兑换，用户注册（邀请人、注册人）奖励积分，生成产品贴码扫码领取积分，积分兑换商品搜索页，支持多商户，无限发布签到活动获取积分 |
...
| 预售 | 提前预售商品降低生产风险、支付预付款、预售结算抵扣下单、可退款，支持多商户和DIY |
| 抽奖 | 九宫格、转盘、砸金蛋幸运抽奖（玩法独立、奖品表独立），支持积分、余额、优惠券即时发放与商品中奖后0元下单 |
| 拼团 | 拼团活动、规格库存与拼团价、虚拟成团、拼团订单管理，支持首页展示与独立拼团详情页，支持多商户 |
| 砍价 | 砍价活动、规格首刀价与底价、帮砍记录、砍价订单管理，支持首页展示与独立砍价详情页，支持多商户 |
| 代客下单 | 代客下单、收银台下单、支持所有订单模式、支持线下支付和扫码支付，适配插件（优惠券、运费设置、积分商城） |
