        ...
        <view class="top-content">
            ...
            <view class="content">
                ...
                <view :class="'user-bottom padding-horizontal-main ' + ((payment_page_url || null) !== null || (vip_page_url || null) !== null ? 'box-shadow' : '')">
                    ...
                    <!-- 会员卡片 -->
                    <component-membership-card ref="membershipCard"></component-membership-card>
...
<script>
    ...
    import componentMembershipCard from '@/components/membership-card/membership-card';
    ...
    export default {
        ...
        onShow() {
            ...
            // 会员卡片刷新
            if ((this.$refs.membershipCard || null) != null) {
                this.$refs.membershipCard.load_data();
            }
